...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
    {
        ...
        context → es como el "administrador" que sabe cómo hablar con la base de datos.

        Activities → es una de las "cajas" que administra context, y ahí van todas las actividades.

        AddRange(...) → significa “agregar varios a la vez”. No es solo un objeto, sino un grupo/lista de cosas.

        activities → es justamente esa lista de actividades que ya tenías preparadas.
